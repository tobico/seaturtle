...
ST.class('Storage', function() {
  this.singleton();
  
  this.classMethod('supported', () => !!(window.openDatabase || window.localStorage));
  
  this.initializer(function(storage) {
  ...
  this.property('storageType');
  
  this.method('isActive', function() {
    return this._storageType !== 'none';
  });
  
  this.method('storageEvent', function(evt) {
  ...
  this.method('set', function(key, value) {
    const self = this;
  ...
  this.method('fetch', function(key, callback) {
    switch (this._storageType) {
      case 'database':
  ...
  this.method('remove', function(key) {
    switch (this._storageType) {
      case 'database':
  ...
  return this.method('removeAll', function() {
    switch (this._storageType) {
      case 'database':
