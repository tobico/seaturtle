STViewController.subClass('STTabController', {
    ...
    destroy: function()
    {
        if (this.tabView) this.tabView.unbindAll(this);
        this.releaseMembers('tabView', 'contentView', 'tabControllers')
            ._super();
    },
    ...
    updateTabView: function()
    {
        ...
        if (this.hideSingleTab && this.tabControllers.count() <= 1) {
            if (this.tabView.loaded) this.tabView.unload();
        } else {
