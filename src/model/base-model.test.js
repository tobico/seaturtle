...
describe("BaseModel", function() {
  ...
  describe(".convertValueToType", function() {
    it("should convert to string", function() {
      const value = BaseModel.convertValueToType(10, 'string')
      expect(typeof value).toEqual('string')
    })
  
    it("should convert to real", function() {
      const value = BaseModel.convertValueToType('5.5', 'real')
      expect(typeof value).toEqual('number')
      expect(value).toEqual(5.5)
    })
  
    it("should convert to integer", function() {
      const value = BaseModel.convertValueToType('5.3', 'integer')
      expect(typeof value).toEqual('number')
    ...
    it("should convert to bool", function() {
      const value = BaseModel.convertValueToType(17, 'bool')
      expect(value).toBe(true)
    })
    
    it("should not convert null", function() {
      const value = BaseModel.convertValueToType(null, 'integer')
