  ...
  Spec.describe 'EnumFieldView', ->
    ...
    describe "initializer", ->
      it "should set defaults", ->
        ...
        @enumField._valueIndex.should equal({})
    ...
    describe "#renderOptions", ->
      it "should render options", ->
        @enumField.load()
        @enumField.selectElement().html().should equal('<option value="" selected="selected"></option><option value="bacon">Bacon</option><option value="waffles">Waffles</option>')
      
      it "should mark value as selected", ->
        @enumField.value 'bacon'
        @enumField.load()
        @enumField.selectElement().html().should equal('<option value=""></option><option value="bacon" selected="selected">Bacon</option><option value="waffles">Waffles</option>')
