...
Spec.describe 'TabController', ->
  ...
  describe "#updateTabView", ->
    ...
    it "should show single tab", ->
      ...
      @tabController.tabs().add tab
      @tabController.view().load()
      @tabController.tabView().element().should haveHtml('<li class="hl"><span class="title active_title">Test</span></li>')
    ...
    it "should show multiple tabs", ->
      ...
      @tabController.tabView().element().should haveHtml('<li><span class="title inactive_title">Foo</span></li><li class="hl"><span class="title active_title">Bar</span></li>')
