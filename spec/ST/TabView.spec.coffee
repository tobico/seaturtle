  ...
  context "with a new tab view", ->
    ...
    describe "#render", ->
      it "should render one tab", ->
        @view.tabs ['Test']
        @view.load()
        @view.element().html().should equal('<li class="hl"><span class="title active_title">Test</span></li>')
      
      it "should render two tabs, first active by default", ->
        @view.tabs ['Active', 'Inactive']
        @view.load()
        @view.element().html().should equal('<li class="hl"><span class="title active_title">Active</span></li><li><span class="title inactive_title">Inactive</span></li>')
      
      it "should render two tabs, second set as active", ->
        @view.tabs ['Inactive', 'Active']
        @view.tabIndex 1
        @view.load()
        @view.element().html().should equal('<li><span class="title inactive_title">Inactive</span></li><li class="hl"><span class="title active_title">Active</span></li>')
